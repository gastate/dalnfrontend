...
const core_1 = __webpack_require__(0);
const environment_1 = __webpack_require__(106);
let CognitoUtil_1 = class CognitoUtil {
    static getAwsCognito() {
        return AWSCognito;
    }
    getUserPool() {
        return new AWSCognito.CognitoIdentityServiceProvider.CognitoUserPool(CognitoUtil_1._POOL_DATA);
    }
    getCurrentUser() {
...
const core_1 = __webpack_require__(0);
let FancyLoaderComponent = class FancyLoaderComponent {
    constructor() {
        this.loading = false;
        this.failed = false;
    }
...
let SearchService = class SearchService {
    ...
    translateAssets(assetType, assetList) {
