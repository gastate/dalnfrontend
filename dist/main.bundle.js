    ...
    PostDetailComponent.prototype.ngOnInit = function () {
        ...
        this.sub = this.router.events.subscribe(function (val) {
            if (val.url.startsWith('/getdev')) {
                ...
                _this.onDetail();
                _this.route = _this.endPoint.share_link + val.url.substring(8);
            }
        });
    };
    ...
    function SearchComponent(location, router, activatedRoute, _postService, _searchService) {
        ...
        this.sub = router.events.subscribe(function (val) {
            ...
            if (route == "/home") {
                ...
                _this.subQuery = _this.activatedRoute.queryParams.subscribe(function (params) {
                    _this.query = params['query'];
                    _this.searchService.searchQuery = _this.query;
                    // this.onSearch(this.query, this.searchService.resultsSize, this.searchService.pageNumber);
                });
                _this.subQuery.unsubscribe();
