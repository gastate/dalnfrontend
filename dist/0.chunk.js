...
let SubmitFormService = class SubmitFormService {
    ...
    getDescriptionFormValues(jsonValue) {
    ...
    getDescriptionArrayValues(subjectValues, nationValues, regionValues, stateValues, geoValues, languageValues) {
