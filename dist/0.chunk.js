...
const submit_form_component_1 = __webpack_require__(1110);
const submit_form_service_1 = __webpack_require__(1104);
const rights_component_1 = __webpack_require__(1109);
const metadata_component_1 = __webpack_require__(1108);
const description_component_1 = __webpack_require__(1106);
const media_component_1 = __webpack_require__(1107);
const license_component_1 = __webpack_require__(1113);
const summary_component_1 = __webpack_require__(1111);
const complete_component_1 = __webpack_require__(1105);
const submit_form_routing_module_1 = __webpack_require__(1114);
const datepicker_component_1 = __webpack_require__(1112);
...
let SubmitFormService = class SubmitFormService {
    ...
    uploadMedia(fileList) {
        ...
        let options = new http_1.RequestOptions({ headers: headers, method: "put" });
        let file; // file to handle during the upload process.
        if (fileList) {
            for (var i = 0; i < fileList.length; i++) {
                file = fileList[i];
